...
public class IngredientHasNBTTag extends Ingredient {
	...
	public ItemStack[] getMatchingStacks() {
		...
		for(int i=0;i<size;i++) {
			...
			if(matchingStacks[i].getItem() instanceof GenericGun) {
				...
				CompoundNBT tags = matchingStacks[i].getTagCompound();
	...
	protected static Object getTagByType(byte id, CompoundNBT tags, String key)
    {
        switch (id)
        {
            /*case 0:
	...
	protected static void setTagByType(byte id, CompoundNBT tags, String key, Object value)
    {
        switch (id)
        {
            /*case 0:
