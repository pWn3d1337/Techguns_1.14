...
public class TGLayerRendererer implements LayerRenderer<PlayerEntity>{
	private boolean slimModel;
	PlayerRenderer renderplayer;
	public TGLayerRendererer(PlayerRenderer renderplayer, boolean slimModel) {
		super();
	...
	@Override
	public void doRenderLayer(PlayerEntity player, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch,
                              float scale) {
	...
	protected boolean isSlotVisible(int slot, PlayerEntity ply) {
		switch(slot) {
	...
	protected void renderSlot(ItemStack slot, PlayerEntity player, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch,
                              float scale) {
		if(!slot.isEmpty()){
