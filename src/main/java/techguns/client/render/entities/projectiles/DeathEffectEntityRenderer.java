...
public class DeathEffectEntityRenderer {
	...
	public static Field RLB_mainModel = ReflectionHelper.findField(LivingRenderer.class, "mainModel", "field_77045_g");
	protected static Method RLB_preRenderCallback = ReflectionHelper.findMethod(LivingRenderer.class, "preRenderCallback", "func_77041_b", LivingEntity.class, float.class);
	protected static Method R_bindEntityTexture = ReflectionHelper.findMethod(EntityRenderer.class, "bindEntityTexture", "func_180548_c", Entity.class);

	public static Field R_renderManager = ReflectionHelper.findField(EntityRenderer.class, "renderManager","field_76990_c");
	
	protected static Method R_bindTexture = ReflectionHelper.findMethod(EntityRenderer.class, "bindTexture","func_110776_a", ResourceLocation.class);
	protected static Method RLB_getColorMultiplier = ReflectionHelper.findMethod(LivingRenderer.class, "getColorMultiplier","func_77030_a" , LivingEntity.class, float.class, float.class);

	

	
	
	public static void preRenderCallback(LivingRenderer<? extends LivingEntity> renderer, LivingEntity elb, float ptt) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
		RLB_preRenderCallback.invoke(renderer, elb, ptt);
	}

	public static void bindEntityTexture(EntityRenderer<? extends Entity> renderer, Entity entity) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
	...
	public static void setRenderScalingForEntity(LivingEntity elb){
		if (elb instanceof SlimeEntity){
			SlimeEntity slime = (SlimeEntity)elb;
     ...
     */
	public static void doRender(LivingRenderer renderer, LivingEntity entity, double x, double y, double z, float ptt, DeathType deathType)
	{
...
//					break;
     ...
     */
    static void renderModelDeathBio(LivingRenderer renderer, LivingEntity entity, float f7, float f6, float f4, float p_77036_5_, float f13, float f5)
    {
...
//    	ModelBase renderPassModel;
    	EntityRendererManager renderManager = null;
    	try {
    		mainModel = (ModelBase)RLB_mainModel.get(renderer);
    		renderManager = (EntityRendererManager)R_renderManager.get(renderer);
//            renderPassModel = (ModelBase)RLB_renderPassModel.get(renderer);
           	R_bindEntityTexture.invoke(renderer, entity);
...
//        TGRenderHelper.disableBlendMode(renderType);
     ...
     * Renders the model in RenderLiving
     */
    static void renderModelDeathLaser(LivingRenderer renderer, LivingEntity entity, float f7, float f6, float f4, float p_77036_5_, float f13, float f5)
    {
    	float prog = ((float)entity.deathTime / (float)MAX_DEATH_TIME); 
...
//        TGRenderHelper.disableBlendMode(renderType);
    ...
    */
    ...
    static void GLTransformDeath_Body(float prog, LivingEntity entity, double xdir, double ydir, double zdir) {
    ...
    static void GLTransformDeath_Head(float prog, LivingEntity entity, Random rand, ModelRenderer head) {
	    double p = Math.min(1.0, prog*2.0);
     ...
     * Renders the model in RenderLiving
     */
    static void renderModel(LivingRenderer renderer, LivingEntity entity, float f7, float f6, float f4, float p_77036_5_, float f13, float f5, ResourceLocation texture, RenderType renderType)
    {
