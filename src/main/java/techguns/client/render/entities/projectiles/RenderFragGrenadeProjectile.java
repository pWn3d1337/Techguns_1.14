...
public class RenderFragGrenadeProjectile extends EntityRenderer<FragGrenadeProjectile> {
	...
	public RenderFragGrenadeProjectile(EntityRendererManager renderManager) {
		super(renderManager);
	}
