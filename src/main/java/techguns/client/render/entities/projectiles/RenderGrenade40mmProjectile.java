...
public class RenderGrenade40mmProjectile extends EntityRenderer<Grenade40mmProjectile> {
	...
	public RenderGrenade40mmProjectile(EntityRendererManager renderManager) {
		super(renderManager);
	}
