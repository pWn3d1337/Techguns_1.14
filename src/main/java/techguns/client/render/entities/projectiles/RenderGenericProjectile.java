...
public class RenderGenericProjectile<T extends GenericProjectile> extends EntityRenderer<T> {
	...
	public RenderGenericProjectile(EntityRendererManager renderManager) {
		super(renderManager);
	}
