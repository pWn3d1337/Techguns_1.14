...
public class RenderNDRProjectile extends EntityRenderer<NDRProjectile> {
	...
	public RenderNDRProjectile(EntityRendererManager renderManager) {
		super(renderManager);
	}
...
//	         z+=offset.z;
	...
	private void setupViewBobbing(float p_78475_1_)
    {
        ...
        {
            PlayerEntity entityplayer = (PlayerEntity)Minecraft.getMinecraft().getRenderViewEntity();
