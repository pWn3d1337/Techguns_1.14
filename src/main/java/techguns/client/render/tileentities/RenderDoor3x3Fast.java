...
public class RenderDoor3x3Fast extends FastTESR<Door3x3TileEntity> {
	...
	public static void stitchTextures(AtlasTexture map) {
	...
	protected void renderDoor0(IBlockAccess world, BlockState state, BufferBuilder buffer, BlockPos pos, boolean zplane, double px, double py, double pz, float prog, IBakedModel L, IBakedModel R, IBakedModel L90, IBakedModel R90) {
	 ...
	 * HangarDoor up
	 */
	protected void renderDoor1(IBlockAccess world, BlockState state, BufferBuilder buffer, BlockPos pos, boolean zplane, double px, double py, double pz, float prog) {
	 ...
	 * HangarDoor down
	 */
	protected void renderDoor2(IBlockAccess world, BlockState state, BufferBuilder buffer, BlockPos pos, boolean zplane, double px, double py, double pz, float prog) {
