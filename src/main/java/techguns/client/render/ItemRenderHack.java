...
public class ItemRenderHack {
	...
	public static boolean renderItem(ItemStack stack, LivingEntity elb, ItemCameraTransforms.TransformType transform, boolean leftHanded){
	...
	protected static boolean shouldRenderItem(ItemStack stack, LivingEntity elb, ItemCameraTransforms.TransformType transform, boolean leftHanded) {
		...
		if (elb.getPrimaryHand()== HandSide.LEFT) {
			mainhand=!mainhand;
		}
		if (mainhand) {
			return true;
