...
public class ClientProxy extends CommonProxy {
	...
	protected static Field RenderPlayer_LayerRenderers = ObfuscationReflectionHelper.findField(LivingRenderer.class, "field_177097_h");//ReflectionHelper.findField(RenderLivingBase.class, "layerRenderers", "field_177097_h");
	...
	*/
	...
	private boolean isLeft(Hand handIn){
		if(this.getPlayerClient().getPrimaryHand()== HandSide.RIGHT){
	...
	private void insertLayerAfterArmor(PlayerRenderer r, TGLayerRendererer tglayer) {
		try {
	...
	public void registerItemRenderers() {
		...
		*/
		...
		ItemRenderHack.registerItemRenderer(TGArmors.steam_Helmet,  new RenderArmorItem(new ModelSteamArmor(0), new ResourceLocation(Techguns.MODID,"textures/models/armor/steam_armor.png"), EquipmentSlotType.HEAD) );
		ItemRenderHack.registerItemRenderer(TGArmors.steam_Chestplate,  new RenderArmorItem(new ModelSteamArmor(0), new ResourceLocation(Techguns.MODID,"textures/models/armor/steam_armor.png"), EquipmentSlotType.CHEST) );
		ItemRenderHack.registerItemRenderer(TGArmors.steam_Leggings,  new RenderArmorItem(new ModelSteamArmor(1), new ResourceLocation(Techguns.MODID,"textures/models/armor/steam_armor.png"), EquipmentSlotType.LEGS) );
		ItemRenderHack.registerItemRenderer(TGArmors.steam_Boots,  new RenderArmorItem(new ModelSteamArmor(0), new ResourceLocation(Techguns.MODID,"textures/models/armor/steam_armor.png"), EquipmentSlotType.FEET) );
	
		ItemRenderHack.registerItemRenderer(TGArmors.t3_power_Helmet,  new RenderArmorItem(new ModelT3PowerArmor(0), new ResourceLocation(Techguns.MODID,"textures/models/armor/powerarmor.png"), EquipmentSlotType.HEAD) );
		ItemRenderHack.registerItemRenderer(TGArmors.t3_power_Chestplate,  new RenderArmorItem(new ModelT3PowerArmor(0), new ResourceLocation(Techguns.MODID,"textures/models/armor/powerarmor.png"), EquipmentSlotType.CHEST) );
		ItemRenderHack.registerItemRenderer(TGArmors.t3_power_Leggings,  new RenderArmorItem(new ModelT3PowerArmor(1), new ResourceLocation(Techguns.MODID,"textures/models/armor/powerarmor.png"), EquipmentSlotType.LEGS) );
		ItemRenderHack.registerItemRenderer(TGArmors.t3_power_Boots,  new RenderArmorItem(new ModelT3PowerArmor(0), new ResourceLocation(Techguns.MODID,"textures/models/armor/powerarmor.png"), EquipmentSlotType.FEET) );
		
		ItemRenderHack.registerItemRenderer(TGArmors.t4_power_Helmet,  new RenderArmorItem(new ModelT4PowerArmorMk2(0), new ResourceLocation(Techguns.MODID,"textures/models/armor/powerarmor_mk2_darkgrey.png"), EquipmentSlotType.HEAD) );
		ItemRenderHack.registerItemRenderer(TGArmors.t4_power_Chestplate,  new RenderArmorItem(new ModelT4PowerArmorMk2(0), new ResourceLocation(Techguns.MODID,"textures/models/armor/powerarmor_mk2_darkgrey.png"), EquipmentSlotType.CHEST) );
		ItemRenderHack.registerItemRenderer(TGArmors.t4_power_Leggings,  new RenderArmorItem(new ModelT4PowerArmorMk2(1), new ResourceLocation(Techguns.MODID,"textures/models/armor/powerarmor_mk2_darkgrey.png"), EquipmentSlotType.LEGS) );
		ItemRenderHack.registerItemRenderer(TGArmors.t4_power_Boots,  new RenderArmorItem(new ModelT4PowerArmorMk2(0), new ResourceLocation(Techguns.MODID,"textures/models/armor/powerarmor_mk2_darkgrey.png"), EquipmentSlotType.FEET) );
	...
	public void setFlySpeed(float value) {
		PlayerEntity ply = getPlayerClient();
	 ...
	 * EntityDeathType
	 */
	public void setEntityDeathType(LivingEntity entity, DeathType deathtype){
		TGDeathTypeCap cap = TGDeathTypeCap.get(entity);
		cap.setDeathType(deathtype);
	}
	
	public DeathType getEntityDeathType(LivingEntity entity) {
		return TGDeathTypeCap.get(entity).getDeathType();
	}
	
	@Deprecated
	public boolean hasDeathType(LivingEntity entity) {
		return TGDeathTypeCap.get(entity).getDeathType() == DeathType.DEFAULT;
	}
	
	@Deprecated
	public void clearEntityDeathType(LivingEntity entity) {
	...
	public void registerFluidModelsForFluidBlock(Block b) {
		...
		ModelLoader.setCustomStateMapper(b, new StateMapperBase() {
			@Override
			protected ModelResourceLocation getModelResourceLocation(final BlockState bs) {
				return modelResourceLocation;
			}
		});
	}
	...
	@Override
	public void clearItemParticleSystemsHand(LivingEntity elb, Hand hand) {
		if(elb instanceof PlayerEntity) {
			TGExtendedPlayerClient props = TGExtendedPlayerClient.get((PlayerEntity) elb);
