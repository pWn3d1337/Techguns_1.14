...
public class TGPackets implements ITGInitializer {
	...
	public static PlayerEntity getPlayerFromContext(MessageContext ctx){
		PlayerEntity thePlayer = (ctx.side.isClient() ? Techguns.proxy.getPlayerClient() : ctx.getServerHandler().player);
		return thePlayer;
	}
