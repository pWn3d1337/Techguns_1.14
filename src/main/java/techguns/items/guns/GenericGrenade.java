...
public class GenericGrenade extends GenericItem implements IItemTGRenderer{
	...
	public void onPlayerStoppedUsing(ItemStack stack, World worldIn, LivingEntity entityLiving, int timeLeft) {
		...
		boolean leftHand = entityLiving.getActiveHand()== Hand.OFF_HAND;
		if(entityLiving.getPrimaryHand()== HandSide.LEFT) {
			leftHand = !leftHand;
		}
    ...
    public void spawnGrenade(World world, LivingEntity entityLiving, float charge, EnumBulletFirePos firePos){
