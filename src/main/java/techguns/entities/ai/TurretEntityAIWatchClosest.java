 ...
 */
public class TurretEntityAIWatchClosest extends Goal
{
    ...
    public TurretEntityAIWatchClosest(MobEntity entityIn, Class <? extends Entity > watchTargetClass, float maxDistance, double yOffset)
    {
    ...
    public TurretEntityAIWatchClosest(MobEntity entityIn, Class <? extends Entity > watchTargetClass, float maxDistance, float chanceIn, double yOffset)
    {
        this.entity = entityIn;
        this.watchedClass = watchTargetClass;
        this.maxDistanceForPlayer = maxDistance;
    ...
    public boolean shouldExecute()
    {
        ...
        else
        {
            ...
            {
                this.closestEntity = this.entity.world.getClosestPlayer(this.entity.posX, this.entity.posY, this.entity.posZ, (double)this.maxDistanceForPlayer, Predicates.and(EntityPredicates.NOT_SPECTATING, EntityPredicates.notRiding(this.entity)));
            }
            else
            {
