...
public class FragGrenadeProjectile extends GrenadeProjectile {
	...
	public FragGrenadeProjectile(World par2World, LivingEntity p, float damage, float speed, int TTL, float spread, float dmgDropStart, float dmgDropEnd, float dmgMin,
	...
	public static class Factory implements IGrenadeProjectileFactory<FragGrenadeProjectile> {
		...
		@Override
		public FragGrenadeProjectile createProjectile(World world, LivingEntity p, float damage, float speed, int TTL, float spread, float dmgDropStart, float dmgDropEnd, float dmgMin, float penetration, boolean blockdamage,
