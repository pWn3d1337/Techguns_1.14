...
public class LaserProjectile extends AbstractBeamProjectile{
	...
	public LaserProjectile(World par2World, LivingEntity p, float damage, float speed, int TTL, float spread,
...
//	}
	...
	public static class Factory implements IProjectileFactory<LaserProjectile> {
		@Override
		public LaserProjectile createProjectile(GenericGun gun, World world, LivingEntity p, float damage, float speed,
