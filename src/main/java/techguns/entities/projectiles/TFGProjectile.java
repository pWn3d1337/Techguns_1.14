...
public class TFGProjectile extends GenericProjectile implements IEntityAdditionalSpawnData, ILightProvider{
	...
	public TFGProjectile(World par2World, LivingEntity p, float damage, float speed, int TTL, float spread, float dmgDropStart, float dmgDropEnd, float dmgMin,
	...
	public static class Factory implements IChargedProjectileFactory<TFGProjectile> {
		...
		@Override
		public TFGProjectile createProjectile(GenericGun gun, World world, LivingEntity p, float damage, float speed, int TTL, float spread, float dmgDropStart, float dmgDropEnd,
		...
		@Override
		public TFGProjectile createChargedProjectile(World world, LivingEntity p, float damage, float speed, int TTL, float spread, float dmgDropStart, float dmgDropEnd,
