...
public class CyberdemonBlasterProjectile extends GenericProjectile {
	...
	public CyberdemonBlasterProjectile(World par2World, LivingEntity p, float damage, float speed, int TTL,
	...
	public static class Factory implements IProjectileFactory<CyberdemonBlasterProjectile> {
		...
		@Override
		public CyberdemonBlasterProjectile createProjectile(GenericGun gun, World world, LivingEntity p, float damage, float speed, int TTL, float spread, float dmgDropStart, float dmgDropEnd,
