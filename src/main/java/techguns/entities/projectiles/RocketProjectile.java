...
public class RocketProjectile extends GenericProjectile implements ILightProvider {
	...
	public RocketProjectile(World par2World, LivingEntity p, float damage, float speed, int TTL, float spread, float dmgDropStart, float dmgDropEnd, float dmgMin,
	...
	public static class Factory implements IProjectileFactory<RocketProjectile> {
		...
		@Override
		public RocketProjectile createProjectile(GenericGun gun, World world, LivingEntity p, float damage, float speed, int TTL, float spread, float dmgDropStart, float dmgDropEnd,
