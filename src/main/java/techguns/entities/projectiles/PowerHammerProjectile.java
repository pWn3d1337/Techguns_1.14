...
public class PowerHammerProjectile extends GenericProjectile {
	...
	public PowerHammerProjectile(World par2World, LivingEntity p, float damage, float speed, int TTL, float spread,
	...
	public static class Factory implements IChargedProjectileFactory<PowerHammerProjectile> {
		...
		@Override
		public PowerHammerProjectile createProjectile(GenericGun gun, World world, LivingEntity p, float damage, float speed, int TTL, float spread, float dmgDropStart, float dmgDropEnd,
		...
		@Override
		public PowerHammerProjectile createChargedProjectile(World world, LivingEntity p, float damage, float speed,
