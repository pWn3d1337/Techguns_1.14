...
public class BlasterProjectile extends GenericProjectile {
	...
	public BlasterProjectile(World par2World, LivingEntity p, float damage, float speed, int TTL, float spread, float dmgDropStart, float dmgDropEnd, float dmgMin,
	...
	public static class Factory implements IProjectileFactory<BlasterProjectile> {
		...
		@Override
		public BlasterProjectile createProjectile(GenericGun gun, World world, LivingEntity p, float damage, float speed, int TTL, float spread, float dmgDropStart, float dmgDropEnd,
