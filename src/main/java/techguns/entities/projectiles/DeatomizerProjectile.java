...
public class DeatomizerProjectile extends GenericProjectile {
	...
	public DeatomizerProjectile(World par2World, LivingEntity p, float damage, float speed, int TTL, float spread,
	...
	public static class Factory implements IProjectileFactory<DeatomizerProjectile> {
		...
		@Override
		public DeatomizerProjectile createProjectile(GenericGun gun, World world, LivingEntity p, float damage, float speed, int TTL, float spread, float dmgDropStart, float dmgDropEnd,
