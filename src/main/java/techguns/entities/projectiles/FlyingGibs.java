...
public class FlyingGibs extends Entity{
	...
	public FlyingGibs(World world, LivingEntity entity, GoreData data, double posX, double posY, double posZ, double motionX, double motionY, double motionZ, float size, int bodypart) {
		super(world);
