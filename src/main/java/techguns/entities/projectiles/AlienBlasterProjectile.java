...
public class AlienBlasterProjectile extends GenericProjectile implements ILightProvider {
	...
	public AlienBlasterProjectile(World par2World, LivingEntity p, float damage, float speed, int TTL, float spread,
	...
	public static class Factory implements IProjectileFactory<AlienBlasterProjectile> {
		...
		@Override
		public AlienBlasterProjectile createProjectile(GenericGun gun, World world, LivingEntity p, float damage, float speed, int TTL, float spread, float dmgDropStart, float dmgDropEnd,
