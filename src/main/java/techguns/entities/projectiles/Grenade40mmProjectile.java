...
public class Grenade40mmProjectile extends GrenadeProjectile {
	...
	public Grenade40mmProjectile(World par2World, LivingEntity p, float damage, float speed, int TTL, float spread, float dmgDropStart, float dmgDropEnd, float dmgMin, float penetration, boolean blockdamage, EnumBulletFirePos leftGun,
	...
	public static class Factory implements IProjectileBounceFactory<Grenade40mmProjectile> {
		...
		@Override
		public Grenade40mmProjectile createProjectile(GenericGun gun, World world, LivingEntity p, float damage, float speed, int TTL, float spread, float dmgDropStart,
