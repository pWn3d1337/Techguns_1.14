...
public class SonicShotgunProjectile extends GenericProjectile implements IEntityAdditionalSpawnData{
	...
	public SonicShotgunProjectile(World par2World, LivingEntity p, float damage, float speed, int TTL, float spread,
		...
		if (mop.entityHit != null )
        {
			if (entitiesHit != null && !entitiesHit.contains(mop.entityHit)) {
	        	...
	        	if (mop.entityHit instanceof LivingEntity){
	        		LivingEntity ent = (LivingEntity) mop.entityHit;
	...
	public static class Factory implements IProjectileFactory<SonicShotgunProjectile> {
		...
		@Override
		public SonicShotgunProjectile createProjectile(GenericGun gun, World world, LivingEntity p, float damage, float speed, int TTL, float spread, float dmgDropStart, float dmgDropEnd,
