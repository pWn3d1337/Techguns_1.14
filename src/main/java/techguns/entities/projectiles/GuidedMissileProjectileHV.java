...
public class GuidedMissileProjectileHV extends GuidedMissileProjectile {
	...
	public GuidedMissileProjectileHV(World par2World, LivingEntity p, float damage, float speed, int TTL,
	...
	public static class Factory implements IChargedProjectileFactory<GuidedMissileProjectileHV> {
		...
		@Override
		public GuidedMissileProjectileHV createProjectile(GenericGun gun, World world, LivingEntity p, float damage,
			...
			if (p instanceof PlayerEntity) {
				TGExtendedPlayer epc = TGExtendedPlayer.get((PlayerEntity)p);
		...
		@Override
		public GuidedMissileProjectileHV createChargedProjectile(World world, LivingEntity p, float damage,
                                                                 float speed, int TTL, float spread, float dmgDropStart, float dmgDropEnd, float dmgMin,
                                                                 float penetration, boolean blockdamage, EnumBulletFirePos firePos, float radius, double gravity,
