...
public class StoneBulletProjectile extends GenericProjectile {
	...
	public StoneBulletProjectile(World par2World, LivingEntity p, float damage, float speed, int TTL, float spread, float dmgDropStart, float dmgDropEnd, float dmgMin,
