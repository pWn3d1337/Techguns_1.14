...
public class AdvancedBulletProjectile extends GenericProjectile{
	...
	public AdvancedBulletProjectile(World world, LivingEntity p, float damage, float speed, int TTL, float spread,
	...
	public static class Factory implements IProjectileFactory<AdvancedBulletProjectile> {
		...
		@Override
		public AdvancedBulletProjectile createProjectile(GenericGun gun, World world, LivingEntity p, float damage, float speed, int TTL, float spread, float dmgDropStart, float dmgDropEnd,
