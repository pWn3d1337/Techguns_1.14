...
//	}
	...
	public TeslaProjectile(World par2World, LivingEntity p, float damage, float speed, int TTL, float spread,
	...
	public TeslaProjectile(World world, LivingEntity shooter, Entity source, LivingEntity target, int chainTargets, float damage, float speed, int TTL, float dmgDropStart,
...
//			}
	...
	protected void onHit(RayTraceResult raytraceResultIn) {
		...
		if (!world.isRemote) {
			...
			if (lastTarget != null && this.chainTargets > 0) {
				LivingEntity nextTarget = findNextTarget(lastTarget);
				if (nextTarget != null) {
	...
	public static class Factory implements IProjectileFactory<TeslaProjectile> {
		@Override
		public TeslaProjectile createProjectile(GenericGun gun, World world, LivingEntity p, float damage, float speed,
