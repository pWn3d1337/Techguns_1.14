...
public class GrenadeProjectile extends GenericProjectile {
	...
	public GrenadeProjectile(World par2World, LivingEntity p, float damage, float speed, int TTL, float spread, float dmgDropStart, float dmgDropEnd, float dmgMin, float penetration, boolean blockdamage, EnumBulletFirePos leftGun, double gravity, float radius, int bounces) {
	...
	protected void hitBlock(RayTraceResult raytraceResultIn) {
		if (this.bounces>0 && !bounced) {
			...
			Direction sideHit = (raytraceResultIn.sideHit);
	...
	public static class Factory implements IGrenadeProjectileFactory<GrenadeProjectile> {
		...
		@Override
		public GrenadeProjectile createProjectile(World world, LivingEntity p, float damage, float speed, int TTL, float spread, float dmgDropStart, float dmgDropEnd, float dmgMin, float penetration, boolean blockdamage,
