...
public class FlamethrowerProjectile extends GenericProjectile implements ILightProvider {
	...
	public FlamethrowerProjectile(World par2World, LivingEntity p, float damage, float speed, int TTL, float spread, float dmgDropStart, float dmgDropEnd, float dmgMin,
	...
	public static class Factory implements IProjectileFactory<FlamethrowerProjectile> {
		...
		@Override
		public FlamethrowerProjectile createProjectile(GenericGun gun, World world, LivingEntity p, float damage, float speed, int TTL, float spread, float dmgDropStart, float dmgDropEnd,
