...
public class RocketProjectileHV extends RocketProjectile {
	...
	public RocketProjectileHV(World par2World, LivingEntity p, float damage, float speed, int TTL, float spread,
	...
	public static class Factory implements IProjectileFactory<RocketProjectileHV> {
		...
		@Override
		public RocketProjectileHV createProjectile(GenericGun gun, World world, LivingEntity p, float damage, float speed, int TTL, float spread, float dmgDropStart, float dmgDropEnd,
