...
public class GaussProjectile extends AdvancedBulletProjectile implements ILightProvider {
	...
	public GaussProjectile(World par2World, LivingEntity p, float damage, float speed, int TTL, float spread,
	...
	public static class Factory implements IProjectileFactory<GaussProjectile> {
		...
		@Override
		public GaussProjectile createProjectile(GenericGun gun, World world, LivingEntity p, float damage, float speed, int TTL, float spread, float dmgDropStart, float dmgDropEnd,
