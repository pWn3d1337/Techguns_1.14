...
public class RocketProjectileNuke extends RocketProjectile {
	...
	public RocketProjectileNuke(World par2World, LivingEntity p, float damage, float speed, int TTL, float spread,
	...
	protected void explodeRocket() {
		if (!this.world.isRemote){
			...
			this.world.playSound((PlayerEntity)null, this.posX, this.posY, this.posZ, TGSounds.NUKE_EXPLOSION, SoundCategory.BLOCKS, 4.0F, 1.0F);
	...
	public static class Factory implements IProjectileFactory<RocketProjectileNuke> {
		...
		@Override
		public RocketProjectileNuke createProjectile(GenericGun gun, World world, LivingEntity p, float damage, float speed, int TTL, float spread, float dmgDropStart, float dmgDropEnd,
