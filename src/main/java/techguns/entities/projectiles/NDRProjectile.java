...
public class NDRProjectile extends AbstractBeamProjectile {
	...
	public NDRProjectile(World par2World, LivingEntity p, float damage, float speed, int TTL, float spread,
	...
	public void onUpdate() {
		...
		if (this.shooter == null) {
			...
			if (e instanceof LivingEntity) this.shooter = (LivingEntity)e;
		}
		if (shooter != null) {
...
//	}
	...
	protected void onHitEffect(LivingEntity ent, RayTraceResult rayTraceResultIn) {
		...
		if(TGRadiationSystem.isEnabled()) {
			ent.addPotionEffect(new EffectInstance(TGRadiationSystem.radiation_effect,40,4,false,true));
		}
	}
	...
	public static class Factory implements IProjectileFactory<NDRProjectile> {
		@Override
		public NDRProjectile createProjectile(GenericGun gun, World world, LivingEntity p, float damage, float speed,
