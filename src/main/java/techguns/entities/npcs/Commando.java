...
public class Commando extends GenericNPC {
	...
	protected void addRandomArmor(int difficulty) {
		...
		// Armors
		this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(TGArmors.t2_commando_Helmet));
		this.setItemStackToSlot(EquipmentSlotType.CHEST,new ItemStack(TGArmors.t2_commando_Chestplate));
		this.setItemStackToSlot(EquipmentSlotType.LEGS, new ItemStack(TGArmors.t2_commando_Leggings));
	    this.setItemStackToSlot(EquipmentSlotType.FEET, new ItemStack(TGArmors.t2_commando_Boots));
