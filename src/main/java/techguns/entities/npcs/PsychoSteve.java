...
public class PsychoSteve extends GenericNPC {
	...
	protected void addRandomArmor(int difficulty) {
		...
		int camo = GenericArmorMultiCamo.getRandomCamoIndexFor((GenericArmorMultiCamo) TGArmors.t1_miner_Chestplate);
			...
			this.setItemStackToSlot(EquipmentSlotType.HEAD, GenericArmorMultiCamo.getNewWithCamo(
				TGArmors.t1_miner_Helmet,camo));
			this.setItemStackToSlot(EquipmentSlotType.CHEST, GenericArmorMultiCamo.getNewWithCamo(
					TGArmors.t1_miner_Chestplate,camo));
			this.setItemStackToSlot(EquipmentSlotType.LEGS, GenericArmorMultiCamo.getNewWithCamo(
					TGArmors.t1_miner_Leggings,camo));
			this.setItemStackToSlot(EquipmentSlotType.FEET, GenericArmorMultiCamo.getNewWithCamo(
					TGArmors.t1_miner_Boots,camo));
			
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(TGuns.chainsaw));
