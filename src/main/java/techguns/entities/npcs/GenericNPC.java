...
public class GenericNPC extends MonsterEntity implements IRangedAttackMob, INPCTechgunsShooter, INpcTGDamageSystem, ITGNpcTeam, ITGSpawnerNPC{
	...
	protected boolean hasAimedBowAnim;
	    ...
	    protected void addRandomArmor(int difficulty){
	        this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(this.pickRandomGun(difficulty)));
	    	
	    	this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(TGArmors.t1_combat_Helmet));
	        this.setItemStackToSlot(EquipmentSlotType.CHEST,new ItemStack(TGArmors.t1_combat_Chestplate));
	        this.setItemStackToSlot(EquipmentSlotType.LEGS, new ItemStack(TGArmors.t1_combat_Leggings));
	        this.setItemStackToSlot(EquipmentSlotType.FEET, new ItemStack(TGArmors.t1_combat_Boots));
	  ...
	  /*  @Override
	     ...
	     */
	    @Override
	    public void readEntityFromNBT(CompoundNBT p_70037_1_)
	    {
	     ...
	     */
	    @Override
	    public void writeEntityToNBT(CompoundNBT p_70014_1_)
	    {
