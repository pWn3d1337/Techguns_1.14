...
public class Ghastling extends MonsterEntity implements IMob, INpcTGDamageSystem, INPCTechgunsShooter, ITGSpawnerNPC {
    ...
    protected void initEntityAI()
    {
         ...
         this.tasks.addTask(7, new WaterAvoidingRandomWalkingGoal(this, 1.0D, 0.0F));
	...
	protected static class AIGhastlingAttack extends Goal
    {
	...
	protected static class AIFireballAttack extends Goal
     {
         private final Ghastling parentEntity;
             ...
             else if (d0 < this.getFollowDistance() * this.getFollowDistance())
             {
                 ...
                 if (this.attackTime <= 0)
                 {
                     ...
                     if (this.attackStep > 1)
                     {
                         ...
                         this.parentEntity.world.playEvent((PlayerEntity)null, 1018, new BlockPos((int)this.parentEntity.posX, (int)this.parentEntity.posY, (int)this.parentEntity.posZ), 0);
