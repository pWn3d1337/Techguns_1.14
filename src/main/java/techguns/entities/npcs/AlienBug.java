...
public class AlienBug extends SpiderEntity implements ITGNpcTeam, INpcTGDamageSystem, ITGSpawnerNPC {
   ...
   public int getAttackTimer()
   {
	...
	protected void initEntityAI() {
		...
		this.targetTasks.addTask(2, new AlienBug.AIAlienBugTarget(this, PlayerEntity.class));
		this.targetTasks.addTask(3, new AlienBug.AIAlienBugTarget(this, IronGolemEntity.class));
	}
