...
public class NPCTurret extends CreatureEntity implements IAnimals, IRangedAttackMob, INPCTechgunsShooter, ITGNpcTeam{
	...
	protected LookRandomlyGoal aiIdle =null;
    ...
    protected Direction turretFacing= Direction.UP;
	...
	public float getEyeHeight() {
		if(this.turretFacing== Direction.DOWN) {
			return 0.15f;
		}
		return 0.75f;
	}
	...
	public void setAITasks(){
		if (aiWatch==null){
			...
			this.aiWatch = new TurretEntityAIWatchClosest(this, LivingEntity.class, 80.0F, 20.0D);
		}
		if(aiIdle==null){
			this.aiIdle = new LookRandomlyGoal(this);
		}
		if(aiHurt==null){
			this.aiHurt =new EntityAIHurtByTargetTGFactions(this, false);
		}
		if(aiTarget==null){
			this.aiTarget= new TurretEntityAINearestAttackableTarget(this, LivingEntity.class, 0, true, false, new Predicate<LivingEntity>() {
					...
					if(NPCTurret.this.mountedTileEnt!=null){
						...
						//	System.out.println("Checking for Target:"+entity);
							...
							//	System.out.println("Checking for Player Target:"+entity);
								UUID ply = ((PlayerEntity)entity).getGameProfile().getId();
								if (ply!=null){
									if (owner.equals(ply)){
										return false;
									}
	...
	public void readFromNBT(CompoundNBT compound) {
		...
		this.turretFacing = Direction.getFront(compound.getByte("turretFacing"));
	}
	...
	public Direction getTurretFacing() {
		return turretFacing;
	}

	public void setTurretFacing(Direction turretFacing) {
