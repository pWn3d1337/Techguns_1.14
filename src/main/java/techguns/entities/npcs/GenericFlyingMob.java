...
public abstract class GenericFlyingMob extends FlyingEntity implements IMob, INpcTGDamageSystem, INPCTechgunsShooter, ITGSpawnerNPC {
	...
	protected static class AILookAround extends Goal
    {
	...
	protected static class AIRandomFly extends Goal
    {
        private final GenericFlyingMob parentEntity;
	...
	protected static class FlyingMobMoveHelper extends MovementController
    {
        private final GenericFlyingMob parentEntity;
