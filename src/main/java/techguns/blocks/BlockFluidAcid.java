...
public class BlockFluidAcid extends BlockFluidClassic {
	...
	@Override
	public void onEntityCollidedWithBlock(World w, BlockPos pos, BlockState state, Entity ent) {
		if (ent instanceof LivingEntity && GenericProjectile.BULLET_TARGETS.apply(ent)){
