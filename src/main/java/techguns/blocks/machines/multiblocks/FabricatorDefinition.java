...
public class FabricatorDefinition extends MultiBlockMachineSchematic {
	...
	private ArrayList<BlockPos> getBottomRow(BlockPos masterPos, Direction direction){
	...
	private ArrayList<BlockPos> getTopRow(BlockPos masterPos, Direction direction){
		masterPos=masterPos.toImmutable();
		...
		topRow.add(masterPos.offset(Direction.UP,1));
		topRow.add(behind.offset(Direction.UP,1));
		topRow.add(leftFront.offset(Direction.UP,1));
		topRow.add(leftBehind.offset(Direction.UP,1));

		return topRow;
	}
	
	@Override
	public boolean checkForm(World w, PlayerEntity ply, BlockPos masterPos, Direction direction) {
