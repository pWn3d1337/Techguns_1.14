...
public class ReactionChamberDefinition extends MultiBlockMachineSchematic {
	...
	protected ArrayList<BlockPos> getGlassBlocks(BlockPos masterPos, Direction direction){
	...
	protected ArrayList<BlockPos> getEnergyConnector(BlockPos masterPos, Direction direction){
		ArrayList<BlockPos> positions = new ArrayList<>();
		BlockPos pos = masterPos.toImmutable();
	...
	protected ArrayList<BlockPos> getSideConnectors(BlockPos masterPos, Direction direction){
		ArrayList<BlockPos> positions = new ArrayList<>();
	...
	protected ArrayList<BlockPos>getNoConnectorHousings(BlockPos masterPos, Direction direction){
	...
	protected ArrayList<BlockPos> getHousingBlocks(BlockPos masterPos, Direction direction){
	...
	public boolean checkForm(World w, PlayerEntity player, BlockPos masterPos, Direction direction) {
		...
		BlockState unformedHousing = TGBlocks.MULTIBLOCK_MACHINE.getDefaultState().withProperty(TGBlocks.MULTIBLOCK_MACHINE.MACHINE_TYPE, EnumMultiBlockMachineType.REACTIONCHAMBER_HOUSING).withProperty(MultiBlockMachine.FORMED, false);
		BlockState unformedGlass = TGBlocks.MULTIBLOCK_MACHINE.getDefaultState().withProperty(TGBlocks.MULTIBLOCK_MACHINE.MACHINE_TYPE, EnumMultiBlockMachineType.REACTIONCHAMBER_GLASS).withProperty(MultiBlockMachine.FORMED, false);
	...
	public void unform(World w, MultiBlockMachineTileEntMaster master) {
		...
		Direction direction = master.getMultiblockDirection();
