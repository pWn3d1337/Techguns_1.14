...
public enum EnumMachineType implements IStringSerializable, IMachineType<EnumMachineType> {
	AMMO_PRESS(0,AmmoPressTileEnt.class,false,false, BlockRenderType.ENTITYBLOCK_ANIMATED),
	METAL_PRESS(1,MetalPressTileEnt.class,false,false, BlockRenderType.ENTITYBLOCK_ANIMATED),
	CHEM_LAB(2,ChemLabTileEnt.class,false,false, BlockRenderType.ENTITYBLOCK_ANIMATED),
	TURRET(3,TurretTileEnt.class,false,false, BlockRenderType.ENTITYBLOCK_ANIMATED),
	DUNGEON_SCANNER(4,DungeonScannerTileEnt.class,true,true, BlockRenderType.MODEL),
	DUNGEON_GENERATOR(5,DungeonGeneratorTileEnt.class,true,true, BlockRenderType.MODEL);
	...
	EnumMachineType(int id, Class<? extends TileEntity> tile, boolean isFullCube, boolean debugonly, BlockRenderType renderType) {
		this(id,tile,isFullCube,debugonly,renderType,BlockRenderLayer.SOLID);
	}
	EnumMachineType(int id, Class<? extends TileEntity> tile, boolean isFullCube, boolean debugonly, BlockRenderType renderType, BlockRenderLayer layer) {
		this.id=id;
