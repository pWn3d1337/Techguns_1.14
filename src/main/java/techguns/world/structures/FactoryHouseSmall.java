...
import net.minecraft.block.DoorBlock.EnumHingePosition;
...
public class FactoryHouseSmall extends WorldgenStructure{
	...
	static {
		...
		blockList.add(new MBlock(TGBlocks.LAMP_0, Direction.NORTH.ordinal()));
		blockList.add(new MBlock(TGBlocks.LAMP_0, Direction.WEST.ordinal()));
		blockList.add(MBlockRegister.FACTORY_PLATE_DOTTED);
		blockList.add(new MBlock(Blocks.CRAFTING_TABLE, 0));
		blockList.add(new MBlock(TGBlocks.BUNKER_DOOR.getDefaultState().withProperty(TGBlocks.BUNKER_DOOR.FACING, Direction.SOUTH).withProperty(TGBlocks.BUNKER_DOOR.HINGE, EnumHingePosition.LEFT).withProperty(TGBlocks.BUNKER_DOOR.HALF, EnumDoorHalf.LOWER)));//TGBlocks.BUNKER_DOOR, 7));
		blockList.add(new MBlock(TGBlocks.BUNKER_DOOR.getDefaultState().withProperty(TGBlocks.BUNKER_DOOR.FACING, Direction.SOUTH).withProperty(TGBlocks.BUNKER_DOOR.HINGE, EnumHingePosition.LEFT).withProperty(TGBlocks.BUNKER_DOOR.HALF, EnumDoorHalf.UPPER)));//TGBlocks.BUNKER_DOOR, 8));
		blockList.add(new MBlock(TGBlocks.LAMP_0, Direction.UP.ordinal()));
		blockList.add(new MBlock(TGBlocks.LAMP_0, Direction.SOUTH.ordinal()));
		blockList.add(new MBlock(Blocks.FURNACE, 3));
		blockList.add(new MBlock(TGBlocks.LAMP_0, Direction.EAST.ordinal()));
		blockList.add(new MBlock(TGBlocks.LADDER_0.getDefaultState().withProperty(TGBlocks.LADDER_0.FACING, Direction.SOUTH)));
