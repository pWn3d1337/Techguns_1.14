...
public class MBlockRegister {
	...
	public static MBlock FACTORY_PLATE_DOTTED = new MBlock(Blocks.HARDENED_CLAY, DyeColor.GRAY.ordinal());
	...
	public static MBlock FACTORY_PLATE_DOTTED_GREY = new MBlock(Blocks.CONCRETE, DyeColor.SILVER.ordinal());
	public static MBlock FACTORY_PLATE_VERY_RUSTY = new MBlock(Blocks.CONCRETE, DyeColor.GRAY.ordinal());
	public static MBlock FACTORY_PLATE_WORN_COLUMN = new MBlock(Blocks.HARDENED_CLAY, DyeColor.SILVER.ordinal());
	...
	public static MBlock ALUMINIUM_STAIRS_WEST = new MBlock(TGBlocks.METAL_STAIRS.getDefaultState().withProperty(TGBlocks.METAL_STAIRS.FACING, Direction.WEST).withProperty(TGBlocks.METAL_STAIRS.HALF, EnumHalf.BOTTOM));
	public static MBlock ALUMINIUM_STAIRS_EAST = new MBlock(TGBlocks.METAL_STAIRS.getDefaultState().withProperty(TGBlocks.METAL_STAIRS.FACING, Direction.EAST).withProperty(TGBlocks.METAL_STAIRS.HALF, EnumHalf.BOTTOM));
	...
	public static MBlock HELIPAD_HAZARDBLOCK = new MBlock(Blocks.CONCRETE, DyeColor.YELLOW.ordinal());
	...
	//limestone
	public static MBlock STONEBRICK_STAIRS_NORTH_INV = new MBlock(Blocks.STONE_BRICK_STAIRS.getDefaultState().withProperty(HorizontalBlock.FACING, Direction.NORTH).withProperty(StairsBlock.HALF, EnumHalf.TOP)); //new MultiMBlock(new Block[]{ChiselBlocks.limestoneStairs[0], ChiselBlocks.limestoneStairs[3]},new int[]{8,0}, new int[]{1,1})
	public static MBlock STONEBRICK_STAIRS_SOUTH_INV = new MBlock(Blocks.STONE_BRICK_STAIRS.getDefaultState().withProperty(HorizontalBlock.FACING, Direction.SOUTH).withProperty(StairsBlock.HALF, EnumHalf.TOP)); //new MultiMBlock(new Block[]{ChiselBlocks.limestoneStairs[0], ChiselBlocks.limestoneStairs[3]},new int[]{8,0}, new int[]{1,1})
	
	public static MBlock STONEBRICK_STAIRS_EAST_CRACKED_RND = new MultiMBlock(new Block[] {Blocks.STONE_BRICK_STAIRS, Blocks.AIR}, new int[] {Blocks.STONE_BRICK_STAIRS.getMetaFromState(Blocks.STONE_BRICK_STAIRS.getDefaultState().withProperty(HorizontalBlock.FACING, Direction.EAST)),0}, new int[] {4,1});
	public static MBlock STONEBRICK_STAIRS_WEST_CRACKED_RND = new MultiMBlock(new Block[] {Blocks.STONE_BRICK_STAIRS, Blocks.AIR}, new int[] {Blocks.STONE_BRICK_STAIRS.getMetaFromState(Blocks.STONE_BRICK_STAIRS.getDefaultState().withProperty(HorizontalBlock.FACING, Direction.WEST)),0}, new int[] {4,1});
	
	public static MBlock STONEBRICK_STAIRS_EAST_CRACKED_INV_RND = new MultiMBlock(new Block[] {Blocks.STONE_BRICK_STAIRS, Blocks.AIR}, new int[] {Blocks.STONE_BRICK_STAIRS.getMetaFromState(Blocks.STONE_BRICK_STAIRS.getDefaultState().withProperty(HorizontalBlock.FACING, Direction.EAST).withProperty(StairsBlock.HALF, EnumHalf.TOP)),0}, new int[] {4,1});
	public static MBlock STONEBRICK_STAIRS_WEST_CRACKED_INV_RND = new MultiMBlock(new Block[] {Blocks.STONE_BRICK_STAIRS, Blocks.AIR}, new int[] {Blocks.STONE_BRICK_STAIRS.getMetaFromState(Blocks.STONE_BRICK_STAIRS.getDefaultState().withProperty(HorizontalBlock.FACING, Direction.WEST).withProperty(StairsBlock.HALF, EnumHalf.TOP)),0}, new int[] {4,1});
