...
public class OreGenerator implements IWorldGenerator {
	...
	public void addOreSpawn(BlockState blockstate, World world, Random random, int blockXPos, int blockZPos, int maxX, int maxZ, int maxVeinSize, int chancesToSpawn, int minY, int maxY)
	{
