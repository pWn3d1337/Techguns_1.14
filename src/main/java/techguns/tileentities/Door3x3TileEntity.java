...
public class Door3x3TileEntity extends BasicRedstoneTileEnt {
	...
	public ITextComponent getDisplayName() {
		return new TranslationTextComponent(Techguns.MODID+".container.door3x3", new Object[0]);
	}
	...
	public void changeStateServerSide() {
		if (!this.world.isRemote) {
			...
			if (entry != null) {
				try {
					List<ServerPlayerEntity> players = (List<ServerPlayerEntity>) ReactionChamberTileEntMaster.playerChunkMapEntry_Players.get(entry);
