...
public class BlastFurnaceTileEnt extends BasicMachineTileEnt {
	...
	public ITextComponent getDisplayName() {
		return new TranslationTextComponent(Techguns.MODID+".container.blast_furnace", new Object[0]);
	}
	...
	protected void playAmbientSound() {
		if(this.world.isRemote) {
			...
			if (this.progress%20==0) {
		        ...
		        Direction enumfacing = world.getBlockState(getPos()).getValue(HorizontalBlock.FACING);
