...
public class TGPlayerInventory implements IInventory {
	...
	public TGPlayerInventory(PlayerEntity player) {
		this.player = player;
	}

	
	public void saveNBTData(CompoundNBT tags) {
		// NBTTagList nbttaglist = new NBTTagList();
		ItemStackHelper.saveAllItems(tags, this.inventory);

		// tags.setTag(name, nbttaglist);
	}
	public void loadNBTData(CompoundNBT tags) {
	...
	public ITextComponent getDisplayName() {
		return new TranslationTextComponent("techguns.extendedinventory", new Object[0]);
	}
