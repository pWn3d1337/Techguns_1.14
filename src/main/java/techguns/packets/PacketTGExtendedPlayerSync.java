...
public class PacketTGExtendedPlayerSync implements IMessage {
	...
	public PacketTGExtendedPlayerSync(PlayerEntity ply, TGExtendedPlayer props, boolean allSlots) {
		super();
	...
	public void fromBytes(ByteBuf buf) {
		...
		if (allSlots) {
			...
			CompoundNBT tags = DataUtil.readCompoundTag(buf);
			if(tags!=null) {
				inv.clear();
