...
public abstract class CommonProxy implements ITGInitializer {
	...
	@SubscribeEvent
    public static void registerPotionTypes(RegistryEvent.Register<Effect> event)
    {

		TGRadiationSystem.RAD_POTION = new Effect(new EffectInstance(TGRadiationSystem.radiation_effect, 300, 4))
                .setRegistryName(Techguns.MODID, "radpotion");
		
		TGRadiationSystem.RAD_POTION_SEVERE = new Effect(new EffectInstance(TGRadiationSystem.radiation_effect, 300, 24))
                .setRegistryName(Techguns.MODID, "radpotion_severe");

		TGRadiationSystem.RAD_REGENERATION_POTION = new Effect(new EffectInstance(TGRadiationSystem.radregen_effect, 400, 9))
                .setRegistryName(Techguns.MODID, "radregenerationpotion");
		
		TGRadiationSystem.RAD_RESISTANCE_POTION = new Effect(new EffectInstance(TGRadiationSystem.radresistance_effect, 900, 1))
	...
	public void handleSoundEvent(PlayerEntity ply, int entityId, SoundEvent soundname, float volume, float pitch, boolean repeat, boolean moving, boolean gunPosition, boolean playOnOwnPlayer, TGSoundCategory soundCategory, EntityCondition condition){
