...
public class TGExtendedPlayer implements ITGExtendedPlayer {
	...
	public static final DataParameter<ItemStack> DATA_FACE_SLOT = EntityDataManager.<ItemStack>createKey(PlayerEntity.class, DataSerializers.ITEM_STACK);
	public static final DataParameter<ItemStack> DATA_BACK_SLOT = EntityDataManager.<ItemStack>createKey(PlayerEntity.class, DataSerializers.ITEM_STACK);
	public static final DataParameter<ItemStack> DATA_HAND_SLOT = EntityDataManager.<ItemStack>createKey(PlayerEntity.class, DataSerializers.ITEM_STACK);
