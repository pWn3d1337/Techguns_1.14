...
//	}
	...
	public static List<TGParticleSystem> createFX(World world, String fx, double posX, double posY, double posZ, double motionX, double motionY, double motionZ) {
		if (FXList.containsKey(fx.toLowerCase())) {
			...
			Techguns.logger_client.warning("FX '"+fx+"' not found!");
					...
					if (sc.hasNext() && !(next = sc.next()).equals("")) {
						...
						switch(key.toLowerCase()) {
							...
							case "rendertype":
								...
								case "ADDITIVE":
									type.renderType = TGRenderType.ADDITIVE;
									break;
								case "ALPHA":
									type.renderType = TGRenderType.ALPHA;
									break;
								case "ALPHA_SHADED":
									type.renderType = TGRenderType.ALPHA_SHADED;
									break;
								case "SOLID":
									type.renderType = TGRenderType.SOLID;
									break;
								case "NO_Z_TEST":
									type.renderType = TGRenderType.NO_Z_TEST;
									break;
								default:
									error = name;
									break;
