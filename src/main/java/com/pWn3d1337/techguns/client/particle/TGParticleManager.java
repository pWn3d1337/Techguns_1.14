...
import com.pWn3d1337.techguns.client.particle.list.ParticleList;
import com.pWn3d1337.techguns.client.particle.list.ParticleList.ParticleListIterator;
...
public class TGParticleManager {
	...
	public void tickParticles() {
		...
		Entity viewEnt = Minecraft.getInstance().getRenderViewEntity();
		...
		if(TGConfig.cl_sortPassesPerTick.get()>0) {
			this.doSorting();
		}
	}

	public void doSorting() {
		this.list.doBubbleSort(TGConfig.cl_sortPassesPerTick.get(), compare);
	}
	...
	public double distanceToPlane(Entity viewEntity, Vector3d pos) {
		...
		Vector3d n = viewEntity.getLookVec();
		double dot1 = -n.dotProduct(pos.subtract(viewEntity.getPositionVec()));
