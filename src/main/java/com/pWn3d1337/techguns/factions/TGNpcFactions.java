package com.pWn3d1337.techguns.factions;

import java.util.UUID;

import com.pWn3d1337.techguns.Techguns;
import com.pWn3d1337.techguns.plugins.ftbl.TeamSystemIntegration;
...
public class TGNpcFactions {
	...
	public static boolean isHostile(PlayerEntity ply1, PlayerEntity ply2) {
		return isHostile(PlayerEntity.getUUID(ply1.getGameProfile()), PlayerEntity.getUUID(ply2.getGameProfile()));
	}
