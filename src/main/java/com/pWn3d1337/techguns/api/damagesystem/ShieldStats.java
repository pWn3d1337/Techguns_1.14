...
public class ShieldStats {
	...
	public static void playBlockSound(LivingEntity ent, TGDamageSource src) {
		...
		if(!w.isRemote) {
			...
			if(!active.isEmpty()) {
				...
				if(s!=null) {
					...
					if(snd!=null) {
						w.playSound(null, ent.prevPosX, ent.prevPosY, ent.prevPosZ, snd, SoundCategory.PLAYERS, 1.0f, 1.0f);
					}
				}
			}
		}
	...
	@Nullable
	public static ShieldStats getStats(ItemStack stack, LivingEntity entity) {
		ShieldStats s = null;
