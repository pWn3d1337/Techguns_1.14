...
import com.pWn3d1337.techguns.deatheffects.EntityDeathUtils.DeathType;
...
public class TGDamageSource extends EntityDamageSource {
	    ...
	    public ITextComponent getDeathMessage(LivingEntity entityLivingBaseIn)
	    {
			...
			if(this.attacker==null && this.damageSourceEntity==null) {	
				...
				itemstack = this.attacker instanceof LivingEntity ? ((LivingEntity)this.attacker).getHeldItemMainhand() : ItemStack.EMPTY;
			}
	        String s = "death.attack." + this.getDamageType();
	        String s1 = s + ".item";
	        return !itemstack.isEmpty() && itemstack.hasDisplayName() && I18n.hasKey(s1) ? new TranslationTextComponent(s1, new Object[] {entityLivingBaseIn.getDisplayName(), itextcomponent, itemstack.getTextComponent()}) : new TranslationTextComponent(s, new Object[] {entityLivingBaseIn.getDisplayName(), itextcomponent});
	    }
		...
		public TGDamageSource(IndirectEntityDamageSource dmg){
